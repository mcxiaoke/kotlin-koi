...
Latest Version: [![Maven Central](https://img.shields.io/badge/2016.02.16-com.mcxiaoke.koi:core:0.5.0-brightgreen.svg)](http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22com.mcxiaoke.koi%22)

```gradle
compile 'com.mcxiaoke.koi:core:0.5.+' // useful extensions (only ~100k)
compile 'com.mcxiaoke.koi:async:0.5.+' // async functions (only ~70k)
```
